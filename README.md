...
header.log.pi.header.log
    ...
    font-weight: 400;
    [div.log.pi.int.loophead]
    header {div.log.pi.pi.loophead}
    HEADER.LOG.pi
    color(blackLuminance)z
    clone {div.log.pi.pi.loophead}
    div.log.pi.pi.loop
    head.log.pi.loop
    head.log.pi.loop
    head.log.pi
    ...
    header.loop
    header.loop.int
header.log.pi.main.powered.box
header
